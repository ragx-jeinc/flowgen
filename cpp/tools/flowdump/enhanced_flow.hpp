#ifndef FLOWDUMP_ENHANCED_FLOW_HPP
#define FLOWDUMP_ENHANCED_FLOW_HPP
...
struct EnhancedFlowRecord {
    ...
    uint64_t timestamp;        // Nanoseconds since Unix epoch (first packet) - for chunking
...
#endif // FLOWDUMP_ENHANCED_FLOW_HPP
